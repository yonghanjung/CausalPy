	...
	while 1: 
		...
		if is_graph_in_list(G, stored_graph_hashes):
			...
			continue
      		...
      		# Use the SAME directional hash for storing as you do for checking.
			new_graph_hash = directional_dag_hash(G)
			stored_graph_hashes.add(new_graph_hash)
   
			# You can still store the graph object itself if you need it later
			store_graph.append(G)
